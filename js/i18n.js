...
var TRANSLATIONS = {
  en: {
    ...
    'bible.originalPanelHint': 'The Hebrew or Greek behind this verse — tap any word for its meaning',
    ...
    'report.placeholder': 'Describe what looks wrong…',
    'report.on': 'About: {where}',
    'report.send': 'Send report',
    'report.sending': 'Sending…',
    'report.thanks': 'Thank you — your report was sent.',
    'report.needText': 'Please describe the problem first.',
    'report.failed': 'Couldn’t send just now. Please try again later.',
    'report.identityLegend': 'How should we sign this?',
    'report.anon': 'Stay anonymous',
    'report.useName': 'Add my name (first name + last initial)',
    'report.firstNamePh': 'First name',
    'report.lastInitialPh': 'Last initial',
    'report.signedInNote': 'You’re signed in, so we can email you a reply. Anonymous reports get no email.',
    'report.ackHeading': 'Thank you for your report!',
    'report.ackP1': 'We’ve received your report and appreciate you taking the time to help us improve the app. Our team will review the issue, including any relevant content or information provided in your report, and determine whether any changes or corrections are needed.',
    'report.ackP2': 'We take reports seriously, especially those involving biblical accuracy, historical or theological context, AI-generated analysis, technical issues, and the overall user experience.',
    'report.ackP3': 'If we confirm an issue, we’ll work to address it as soon as possible. In some cases, we may need additional information to investigate the problem further.',
    'report.ackP4': 'Thank you for helping us build a more accurate, reliable, and useful resource for studying Scripture, evangelism, and apologetics.',
    ...
    'admin.title': 'Admin',
    'admin.lede': 'Add maps, archaeology, chapter questions, and definitions. Everything you publish here appears for every visitor.',
    'admin.unlockLede': 'Enter your admin key to publish shared content. The key is kept only on this device.',
    'admin.key': 'Admin key',
    'admin.keyPh': 'Your secret admin key',
    'admin.unlock': 'Unlock',
    'admin.checking': 'Checking…',
    'admin.badKey': 'That key wasn’t accepted.',
    'admin.unlocked': 'Unlocked on this device.',
    'admin.lock': 'Lock',
    ...
    'admin.saving': 'Saving…',
    'admin.published': 'Published “{name}”.',
    'admin.publishedFaq': 'Published {n} question(s) for {scope}.',
    'admin.failed': 'That didn’t save. Check your key and try again.',
    'admin.group': 'Group',
    'admin.scope': 'Where it applies',
    'admin.scopePh': 'e.g. Genesis 1  (or just Genesis)',
    'admin.imgUrl': 'Image URL',
    'admin.imgUrlPh': 'https://…',
    'admin.imgUrlOpt': 'Image URL (optional)',
    'admin.imgUrlOptPh': 'https://…',
    'admin.needTermDef': 'Add a term and a definition.',
    'admin.needScopeImg': 'Add where it applies and an image URL.',
    'admin.needScopeDesc': 'Add where it applies and a description.',
    'admin.needScopeQa': 'Add where it applies and at least one question and answer.',
    'admin.defTitle': 'Definitions',
    'admin.defHint': 'Publish a definition and pick its group. It appears in the Definitions list for everyone.',
    'admin.defTerm': 'Term',
    'admin.defTermPh': 'e.g. Shalom',
    'admin.defDef': 'Definition',
    'admin.defDefPh': 'Its meaning, roots, and a key verse…',
    'admin.defPron': 'Pronunciation',
    'admin.defPronPh': 'e.g. shah-LOHM',
    'admin.defMeaning': 'Meaning',
    'admin.defMeaningPh': 'A short gloss',
    'admin.defPeopleHeading': 'For people (shown only for the People group)',
    'admin.defFirstApp': 'First appearance',
    'admin.defFirstAppPh': 'e.g. Genesis 12:1',
    'admin.defFather': 'Father',
    'admin.defFatherPh': 'e.g. Terah',
    'admin.defMother': 'Mother',
    'admin.defMotherPh': 'Mother’s name',
    'admin.defSiblings': 'Siblings',
    'admin.defSiblingsPh': 'e.g. Nahor, Haran',
    'admin.defChildren': 'Children',
    ...
    'admin.mapName': 'Title',
    'admin.mapTitlePh': 'e.g. The Ancient Near East',
    'admin.mapCap': 'Caption',
    'admin.mapCapPh': 'A short caption (optional)',
    'admin.archTitle': 'Archaeology',
    'admin.archHint': 'Add an archaeological note or find shown in Background & world.',
    'admin.archName': 'Title',
    'admin.archNamePh': 'e.g. The Merneptah Stele',
    ...
    'admin.msgTitle': 'Message reporters',
    'admin.msgHint': 'Send a note to everyone who has reported a problem. It appears as an in-app notification for each of them, and is emailed to those who left an address.',
    'admin.msgSubject': 'Subject',
    'admin.msgSubjectPh': 'e.g. Thanks — the verse is fixed',
    'admin.msgBody': 'Message',
    'admin.msgBodyPh': 'Write your message to reporters…',
    'admin.msgSend': 'Send to all reporters',
    'admin.msgSending': 'Sending…',
    'admin.msgSent': 'Sent — {notified} in-app, {emailed} emailed.',
    'admin.msgFailed': 'That didn’t send. Check your key and try again.',
    'admin.msgNeedBody': 'Write a message first.',
    'admin.msgConfirm': 'Send this message to everyone who has reported a problem?',
    ...
    'home.firstRunTitle': 'Welcome — let’s begin',
    'home.firstRunLede': 'New here? Pick one place to start. Everything else will be waiting when you’re ready.',
    'home.firstRunPlan': 'Follow a reading plan',
    'home.firstRunPlanHint': 'A guided path through scripture, a little each day',
    'home.firstRunBible': 'Open the Bible',
    'home.firstRunBibleHint': 'Read any book, chapter by chapter',
    'home.firstRunTips': 'New to faith? Start here',
    'home.firstRunTipsHint': 'Where to begin when everything is new',
    ...
    'search.wordHeading': 'Search by word or topic',
    'search.wordLede': 'Looking for a theme rather than a reference? Find every verse that mentions a word — like love, forgiveness, or faith. Results are drawn from the World English Bible; tap any verse to open it in the reader.',
    'search.wordPlaceholder': 'love, forgiveness, faith…',
    'search.wordSubmit': 'Search',
    'search.wordBusy': 'Searching the scriptures…',
    'search.wordNone': 'No verses found for “{q}”. Try a different word.',
    'search.wordCount': '{n} verses mention “{q}” — tap one to open it.',
    'search.wordMore': 'Showing the first {n}. Try a more specific word to narrow it down.',
    'search.wordError': 'Couldn’t run that search just now. Please check your connection and try again.',
    ...
    'definitions.adminPronPh': 'Pronunciation (e.g. shah-LOHM)',
    'definitions.adminMeaningPh': 'Meaning — a short gloss',
    'definitions.adminPeopleHeading': 'For people (optional)',
    'definitions.adminFirstAppPh': 'First appearance (e.g. Genesis 12:1)',
    'definitions.adminFatherPh': 'Father',
    ...
    'definitions.adminEdit': 'Edit',
    'definitions.pronLabel': 'Pronunciation',
    'definitions.meaningLabel': 'Meaning',
    'definitions.photosLabel': 'Photos',
    'definitions.genealogyHeading': 'Family & first appearance',
    'definitions.firstAppLabel': 'First appearance',
    'definitions.fatherLabel': 'Father',
    ...
    'notif.reportAck.title': 'Report received',
    'notif.reportAck.body': 'Thank you — we got your report and are looking into it.',
